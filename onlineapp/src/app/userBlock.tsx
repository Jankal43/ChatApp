...
export default function UserBlock(props: any) {
  ...
  return (
    <div className="userBlock h-full">
      <div className="appDescription bg-gray-900 m-1 p-5 h-1/3 text-7xl font-bold text-center">
        CHAT SYSTEM
      </div>
      <div className="userDescription bg-gray-900 m-1 p-5 h-2/3">
        ...
        {userNickname === "" ? (
          ...
          <div className="userName">
            <p className="text-center" id="username">
              {userNickname}{" "}
            </p>
            <button
              onClick={handleButtonClick}
              className="bg-red-900 hover:bg-red-700 text-white font-semibold py-2 p-3 border shadow"
            >
              Disconnect
            </button>
          </div>
